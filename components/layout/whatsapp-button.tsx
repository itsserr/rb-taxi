...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/30 transition-transform duration-200 hover:scale-105 sm:bottom-8 sm:right-8"
    >
      <svg
        viewBox="0 0 24 24"
